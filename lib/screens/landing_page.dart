...
//                 style: KineticButtonStyle.secondary,
//                 onPressed: () => context.push('/trainer-dashboard'),
//               ),
//               const SizedBox(height: 16),
//               KineticButton(
//                 text: 'Login as Owner',
      ...
      children: [
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('COMMUNITY HUB', style: TextStyle(color: Colors.white, fontSize: isMobile ? 32 : 40, fontWeight: FontWeight.bold, letterSpacing: -1, height: 1.1)),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Text('GLOBAL EVENT', style: TextStyle(color: Colors.white60, fontSize: 12, letterSpacing: 1.5, fontWeight: FontWeight.bold)),
                      ],
                    ),
                    const SizedBox(height: 12),
                    const Text('30-DAY SHRED', style: TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.w800, fontStyle: FontStyle.italic, height: 1)),
                    const SizedBox(height: 8),
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                height: 48,
                decoration: BoxDecoration(
                  color: isCompleted ? kPrimary.withOpacity(0.2) : kSecondaryContainer.withOpacity(0.2),
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Icon(icon, color: isCompleted ? kPrimary : kSecondaryContainer),
              ),
          ...
          if (!isCompleted && progress != null) ...[
            LinearProgressIndicator(
              ...
              valueColor: const AlwaysStoppedAnimation(kSecondaryContainer),
            ...
            Row(
              ...
              children: [
                ...
                Text('${(progress! * 100).toInt()}%', style: const TextStyle(color: kSecondaryContainer, fontSize: 12, fontWeight: FontWeight.bold)),
              ],
            )
          ] else ...[
            Row(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const CircleAvatar(
                          radius: 20,
                          backgroundImage: NetworkImage('https://lh3.googleusercontent.com/aida-public/AB6AXuCJtlbmgEczVUxx9bsWhmU_sktCllZ9ErPvJKZo6wI6CYXNeSjCKvBoyCwQvHmpY44NpDNwx9nlak31chQPJFGhKJp9fIJ_Guhea1wGwBj-xzFcD-fkHLBNB3PmKnZYWAXvhS0cXOEzju8Koi287XJ0rBBVkfDhWa1VIjwQgLv8SFbbCCeWGqUiIM2Rkd_tO_pZbTUbvYtQOtV5x3eAUasV9SfxFb_kBl2xNrOtrYU57sSAvy8_pEH0lzoy3I_oJiX2Fo8SVc2Lj8s'),
                        ),
                        const SizedBox(width: 12),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: kSurfaceHigh, borderRadius: BorderRadius.circular(20)),
        ...
        GridView.count(
          ...
          children: const [
            ...
            _BadgeCard(title: 'Early Bird', desc: '5AM Workouts', icon: Icons.schedule, iconColor: kSecondaryContainer),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: kSurfaceHigh,
                border: Border.all(color: isLocked ? Colors.white.withOpacity(0.05) : Colors.white.withOpacity(0.1)),
                ...
                Row(
                  children: [
                    if (MediaQuery.of(context).size.width > 768) ...[
                      ...
                      const SizedBox(width: 32),
                      const Text('Members', style: TextStyle(color: kOnSurfaceVariant, fontSize: 14)),
                      const SizedBox(width: 32),
                    ],
                    IconButton(

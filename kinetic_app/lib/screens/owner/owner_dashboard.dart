            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _buildNavCard(context, 'SaaS Sub', Icons.cloud_queue, '/owner/saas-subscription'),
                  _buildNavCard(context, 'Branches', Icons.corporate_fare, '/owner/branches'),
                  _buildNavCard(context, 'SaaS Settings', Icons.tune, '/owner/tenant-settings'),
                  _buildNavCard(context, 'Super Admin', Icons.admin_panel_settings, '/superadmin/dashboard'),
                ],
              ),
            ],
          ),
